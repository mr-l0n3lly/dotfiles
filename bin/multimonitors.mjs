...
if (Number(monitors) === 1) {
  ...
  await $`xrandr --output eDP-1 --primary --mode 1920x1080 --pos 1630x1440 --rotate normal --output HDMI-1 --mode 2560x1440 --pos 2560x0 --rotate normal --output DP-1 --mode 2560x1440 --pos 0x0 --rotate normal --output HDMI-2 --off --output DP-2 --off --output HDMI-3 --off`;
}
